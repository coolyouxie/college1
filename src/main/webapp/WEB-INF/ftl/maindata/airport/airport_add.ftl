			...
			<div class="product ms">
				<div class="main">
					...
					<div class="part" style="text-align :center">
						<span>机场名称：</span><input type="text" id="fullName" name="fullName" maxlength="50"/>
						<span>简称：</span><input type="text" id="name" name="name" maxlength="50"/>
						<span>机场三字代码：</span><input type="text" id="code" name="code" maxlength="3" style="IME-MODE: disabled;" 
							onkeyup="value=value.trim().toUpperCase()" onafterpaste="value=value.trim().toUpperCase()"/>
					</div>
					<div class="part" style="text-align :center">
						<span>机场城市：</span><input type="text" id="cityName" name="cityName" maxlength="50"/>
						<span>城市三字代码：</span><input type="text" id="cityCode" name="cityCode" maxlength="3" style="IME-MODE: disabled;" 
							onkeyup="value=value.trim().toUpperCase()" onafterpaste="value=value.trim().toUpperCase()"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
					<div class="part" style="text-align :center">
						<span>城市全拼：</span><input type="text" id="pinYin" name="pinYin" maxlength="50" style="IME-MODE: disabled;" 
							onkeyup="value=value.trim().toUpperCase()" onafterpaste="value=value.trim().toUpperCase()"/>
						<span>城市简拼：</span><input type="text" id="jianPin" name="jianPin" maxlength="10" style="IME-MODE: disabled;" 
							onkeyup="value=value.trim().toUpperCase()" onafterpaste="value=value.trim().toUpperCase()"/>
						<span>城市热度：</span><input type="text" id="hot" name="hot" maxlength="3" style="IME-MODE: disabled;" 
