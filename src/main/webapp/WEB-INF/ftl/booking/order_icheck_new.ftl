         ...
         <div class="msg">
             ...
             <div class="price">
                 <table cellpadding="0" cellspacing="0">
                     <tr><td>&nbsp;</td><td>票面价</td><td>机建费</td><td>燃油费</td><td>优惠价格</td><td>销售价</td><td>供应商</td><td class="last-td">供应商政策ID</td></tr>
						...
						<td>${(detail.combinationDetail.flightOrderFlightPolicy.supp.code)!''}</td>
