<#list segList as flightInfos> 
					...
					<tr>
						...
						<div id="modifyOWFlightDiv">
							...
							<#if flightInfos.routeType=='RT'>
								...
								<input type="hidden" name="bookingFirstDto.pricePolicyId" value="${flightInfos.bookingFirstDto.pricePolicyId}"/>
		...
		<div class="price">
			...
			<table cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td>[${(productPrice.pricePolicyId)}]</td>
					<td>${(productPrice.suppCode)}</td>
		...
		<#list rebookingDetailRequests as request >
		    <input type="hidden" name="request_request_index" value="${request_index}"/>
		    <input type="hidden" name="request_departureAirportCode"  value="${request.departureAirportCode}"/>
		    <input type="hidden" name="request_arrivalAirportCode"  value="${request.arrivalAirportCode}"/>
		    <input type="hidden" name="request_departureDate"  value="${request.departureDate}"/>
		    <input type="hidden" name="request_flightNo"  value="${request.flightNo}"/>
		    <input type="hidden" name="request_flightTripType"  value="${request.flightTripType}"/>
		    <input type="hidden" name="request_parPrice"  value="${request.parPrice}"/>
		    <input type="hidden" name="request_policyId"  value="${request.policyId}"/>
		    <input type="hidden" name="request_pricePolicyId"  value="${request.pricePolicyId}"/>
		    <input type="hidden" name="request_seatClassCode"  value="${request.seatClassCode}"/>
		</#list>
