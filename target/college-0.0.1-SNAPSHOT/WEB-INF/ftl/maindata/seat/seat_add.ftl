			...
			<div class="product ms">
				<div class="main">
					...
					<div class="part" style="text-align :center">
						...
						<span>舱位代码：</span><input type="text" id="code" name="code" maxlength="2" style="IME-MODE: disabled;" 
							onkeyup="value=value.trim().toUpperCase()" onafterpaste="value=value.trim().toUpperCase()"/>
						<span>舱位折扣：</span><input type="text" id="discount" name="discount" maxlength="3" style="IME-MODE: disabled;" 
					...
					<div class="part" style="text-align :center">
						...
						<select id="seatClassType" name="seatClassType" style="width:90px">
							<#list seatClassTypeEnum as val>  
								<option value="${val}" selected>${val.cnName}</option>
							</#list>
						</select>
						<span>舱位说明：</span><input type="text" id="name" name="name" maxlength="50"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
					<div class="part" style="text-align :center">
						<span style="vertical-align:top">退改签说明：</span><textarea id="ticketRule" name="ticketRule" style="resize: none;width: 500px;height: 100px;"  
							onpropertychange="if(value.length>1000) value=value.substr(0,1000)" oninput="if(value.length>1000) value=value.substr(0,1000)"></textarea>
						&nbsp;&nbsp;&nbsp;
					</div>
					<div class="part" style="text-align :center">
