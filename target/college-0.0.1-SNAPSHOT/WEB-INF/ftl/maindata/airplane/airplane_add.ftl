			...
			<div class="product ms">
				<div class="main">
					...
					<div class="part" style="text-align :center">
						<span>机型名称：</span><input type="text" id="name" name="name" maxlength="100"/>
						<span>机型代码：</span><input type="text" id="code" name="code" maxlength="10" style="IME-MODE: disabled;"/>
						<span>类型：</span><input type="text" id="airplaneType" name="airplaneType" maxlength="10"/>
					</div>
					<div class="part" style="text-align :center">
						<span>最少座位数：</span><input type="text" id="minSeats" name="minSeats" maxlength="4" style="IME-MODE: disabled;" 
							onkeyup="value=value.replace(/[^\d]/g,'')" onafterpaste="value=value.replace(/[^\d]/g,'')"/>
						<span>最大座位数：</span><input type="text" id="maxSeats" name="maxSeats" maxlength="4" style="IME-MODE: disabled;" 
							onkeyup="value=value.replace(/[^\d]/g,'')" onafterpaste="value=value.replace(/[^\d]/g,'')"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
