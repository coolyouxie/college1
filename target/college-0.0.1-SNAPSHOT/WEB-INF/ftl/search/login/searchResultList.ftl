        ...
        <div class="datebox mt10">
         ...
         <div class="t_content">
            ...
            <div class="bor_orange">
                ...
                <form id="${flight.flightNo}${seat.id}${seat.policyId}_1" action="toBooking.do" method="post">
                ...
                <div  class="airmsg03" id="${flight.flightNo}_${seat_index}${seat.policyId}_1">
                    <ul>
                        ...
                        <li class="w10 blue ml1 tl return_hover" carrierCode='${flight.carrierCode}' departAirportCode='${flight.departureAirportCode}' 
                        	arriveAirportCode='${flight.arrivalAirportCode}' parPrice='${seat.parPrice}' policyId='${seat.policyId}' seatClassCode='${seat.seatClassCode}'
                        >
                        	退改签说明
                        	<div class="endorse_detail"></div>
                        </li>
                        <li class="w10">[${seat.suppPolicyId}]</li>
                        <li class="w6">&nbsp;</li>
                        ...
                        <li class="w8 orangebut tc"><a href="javascript:void(0);" class="bookbut" flightNo="${flight.flightNo}" seatId="${seat.id}" departAirportCode="${flight.departureAirportCode}" 
                        	arriveAirportCode="${flight.arrivalAirportCode}" parPrice="${seat.parPrice}" policyId="${seat.policyId}" seatClassCode="${seat.seatClassCode}" departDate="${objSear.departDate}" carrierCode="${flight.carrierCode}" onclick="bookingAjax(this);" >预定</a></li>
                ...
                <ul style="background:#F6F6F6;height:100px;">
                    ...
                    <li class="w27 tc">
                     ...
                     <li class="w18 w10 blue ml1 tl return_hover_history" carrierCode='${bookingFirstDto.carrierCode}' departAirportCode='${bookingFirstDto.departAirportCode}' 
                        	arriveAirportCode='${bookingFirstDto.arriveAirportCode}' parPrice='${bookingFirstDto.parPrice}' policyId='${bookingFirstDto.policyId}' seatClassCode='${bookingFirstDto.seatClassCode}'
                        >
            ...
            <div class="t_content">
                <div class="content">
                    ...
                    <div class="bor_orange">
                        ...
                        <#list flight.yCFseats as seat>
                        <#if bookingFirstDto??>
                        <form id="${flight.flightNo}${seat.id}${seat.policyId}_2" action="toBooking.do" method="post">
                        ...
                        <form id="${flight.flightNo}${seat.id}${seat.policyId}_2" action="search" method="post">
                        ...
                        <input type="hidden" id="${flight.flightNo}${seat.id}${seat.policyId}_3" name="doWay" />
                        </#if>
                        </form>
                        
                        <div class="airmsg03" id="${flight.flightNo}_${seat_index}${seat.policyId}_2">
                            <ul>
                                <li class="w18">&nbsp;&nbsp;&nbsp;&nbsp;${seat.seatClassTypeName}</li>
                                <li class="w16 tr">${seat.seatClassName}${seat.seatClassCode}</li>
                                <li class="w10 blue ml1 tl return_hover" carrierCode='${flight.carrierCode}' departAirportCode='${flight.departureAirportCode}' 
...
//		}
    	...
    	obj1.policyId = $(obj).attr('policyId');
    	...
    	if(doWay == 1){
    		$.ajax({
    			url : 'verifySeatAndPrice',// 跳转到 action    
    			contentType:"application/json;",
    			dataType:"json",
    			data : JSON.stringify({
    			...
    			success : function(data) {
    				if(data.status == 'SUCCESS'){
    					...
    					var form = $('#'+flightNo+seatId+policyId+"_1");
    					form.append(input1);
    					form.append(input2);
    					form.append(input3);
    					form.submit();
    		...
    		$.ajax({
    			...
    			success : function(data) {
		    		if(data.status == 'SUCCESS'){
    					...
    					var input2 = $("<input type='hidden' name='vstOrderMainId' />");
    					input2.attr('value','${objSear.vstOrderMainId}');
    					var form = $('#'+flightNo+seatId+policyId+"_2");
    					form.append(input1);
    					form.append(input2);
    					form.append(input3);
		    			$('#'+flightNo+seatId+policyId+"_3").val(doWay);
			    		form.submit();
    				}else{
    					$(obj).css('cursor', 'no-drop');
    					var input2 = $("<input type='hidden' name='vstOrderId' />");
    					...
    					<#if bookingFirstDto??>
	    			        ...
	    			        form.append(input3);
	    			        form.append(input4);
//	    			        form.html($('#bookingFirstDtoDiv').html());
	    					form.submit();
    					<#else>
	    					var form = $('#formHideOW');
	    					var input1 = $("<input type='hidden' name='selectedFlightNo' />");
...
//    $(".datebox .date-rili").click(function(){
//    	
